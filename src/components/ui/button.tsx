  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        soft: "bg-secondary text-secondary-foreground border border-border hover:bg-accent hover:-translate-y-0.5",
        onPrimary:
          "bg-card text-primary shadow-[var(--shadow-card)] hover:brightness-105 hover:-translate-y-0.5",
        onPrimaryOutline:
